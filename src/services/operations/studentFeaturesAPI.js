...
const RAZORPAY_KEY = "rzp_test_qcnwFqPeh6VSs5"
...
export const buyCourse = async (token, courses, userDetails, navigate, dispatch,) => {
    ...
    try {
        ...
        // Open the modal using options, as 
        // order is initialized => payment will be done =>  Payment done mail => verificationPayment => course successfully enrolled mail sent
